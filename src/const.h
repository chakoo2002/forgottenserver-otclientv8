...
enum ReloadTypes_t : uint8_t  {
	...
	RELOAD_TYPE_HEALTHBARS,
	RELOAD_TYPE_ITEMS,
	RELOAD_TYPE_MANABARS,
...
//[2045 - 2055];
static constexpr int32_t PSTRG_HEALTHBARS_RANGE_START = (PSTRG_RESERVED_RANGE_START + 2045);
static constexpr int32_t PSTRG_HEALTHBARS_RANGE_SIZE = 10;
static constexpr int32_t PSTRG_HEALTHBARS_CURRENTHEALTHBAR = (PSTRG_HEALTHBARS_RANGE_START + 10);
//[2056 - 2056];
static constexpr int32_t PSTRG_MANABARS_RANGE_START = (PSTRG_RESERVED_RANGE_START + 2056);
static constexpr int32_t PSTRG_MANABARS_RANGE_SIZE = 10;
static constexpr int32_t PSTRG_MANABARS_CURRENTMANABAR = (PSTRG_MANABARS_RANGE_START + 10);
